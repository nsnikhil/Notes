...
import com.nrs.nsnik.notes.model.data.NoteEntity;
...
public class NoteViewModel extends AndroidViewModel {
    ...
    public NoteViewModel(Application application, String folderName) {
        super(application);
        mFolderName = folderName;
        mNotesDatabase = ((MyApplication) application).getNotesDatabase();
        mNoteList = mNotesDatabase.getNoteDao().getNoteByFolderName(mFolderName);
    }
