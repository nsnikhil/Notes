...
import com.nrs.nsnik.notes.dagger.modules.GlideModule;
import com.nrs.nsnik.notes.dagger.scopes.GlideScope;
...
public interface GlideComponent {
    void injectImageAdapter(ImageAdapter imageAdapter);

    void injectNotesAdapter(NotesAdapter notesAdapter);
}
